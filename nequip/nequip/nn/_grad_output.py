...
class StressOutput(GraphModuleMixin, torch.nn.Module):
    ...
    def __init__(
        ...
        self.irreps_out[AtomicDataDict.VIRIAL_KEY2] = "1o" #shimamura for heat flux
    ...
    def forward(self, data: AtomicDataDict.Type) -> AtomicDataDict.Type:
        ...
        ##shimamura for heat flux
        #data[AtomicDataDict.VIRIAL_KEY2] = virial
...
class ParaStressOutput(GraphModuleMixin, torch.nn.Module):
    ...
    def __init__(
        ...
        self.irreps_out[AtomicDataDict.VIRIAL_KEY2] = "3x1o" #shimamura for heat flux
        self.irreps_out[AtomicDataDict.ATOM_VIRIAL_KEY] = "3x1o"
        self.irreps_out[AtomicDataDict.ATOM_VIRIAL_KEY2] = "3x1o" #shimamura for heat flux
    ...
    def forward(self, data: AtomicDataDict.Type) -> AtomicDataDict.Type:
        ...
        #shimamura for symmetry atomic virial
        # Store virial
        ...
        edge_virial = torch.einsum(
            "zi,zj->zij", data[AtomicDataDict.EDGE_VECTORS_KEY], vector_force
        )
        #edge_virial = torch.einsum(
        ...
        virial2 = scatter(atom_virial2, batch, dim=0, reduce="sum")

        if virial2 is None:
            # condition needed to unwrap optional for torchscript
            assert False, "failed to compute virial2 autograd"
        ...
        #shimamura for heat flux
        virial2 = torch.neg(virial2)
        atom_virial2 = torch.neg(atom_virial2)
        data[AtomicDataDict.VIRIAL_KEY2] = virial2
        data[AtomicDataDict.ATOM_VIRIAL_KEY2] = atom_virial2
