...
VIRIAL_KEY2: Final[str] = "virial2" #shimamura for heat flux
ATOM_VIRIAL_KEY: Final[str] = "atom_virial"
ATOM_VIRIAL_KEY2: Final[str] = "atom_virial2" #shimamura for heat flux
...
ALL_ENERGY_KEYS: Final[List[str]] = [
    ...
    STRESS_KEY,
    VIRIAL_KEY,
    VIRIAL_KEY2,#shimamura for heat flux
    ATOM_VIRIAL_KEY,
    ATOM_VIRIAL_KEY2, #shimamura for heat flux
]
