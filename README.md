...
By reading this atomic virial tensor in the molecular dynamics code and constructing the heat flux, one can perform a heat conductivity calculation based on the Green-Kubo formula.
